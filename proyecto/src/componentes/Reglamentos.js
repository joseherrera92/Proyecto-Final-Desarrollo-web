...
import arbitroreglamento1 from './Img/arbitroreglamento1.jpg';
import arbitroreglamento2 from './Img/arbitroreglamento2.jpg';
import arbitroreglamento3 from './Img/arbitroreglamento3.jpg';
    ...
    return(
        ...
        <section  className='reglamentos'>
            <article className='reglamento-liga'>
                ...
                <figure>
                    <a href="#">
                    <img className="arbitroreglamento1" src={arbitroreglamento1} alt="./Img/arbitroreglamento1.jpg"/>
                    </a>
                </figure>
            </article>
            ...
            <article className='reglamento-festival'>
                ...
                <figure>
                    <a href="#">
                    <img className="arbitroreglamento2" src={arbitroreglamento2} alt="./Img/arbitroreglamento2.jpg"/>
                    </a>
                </figure>
            ...
            <article className='reglamento-jugador'>
                ...
                <figure>
                    <a href="#">
                    <img className="arbitroreglamento3" src={arbitroreglamento3} alt="./Img/arbitroreglamento3.jpg"/>
                    </a>
                </figure>
            </article>
            ...
            <article className='regalemnto-aficion'>
                ...
                <figure>
                    <a href="#">
                    <img className="banderin" src={foto_banderin} alt="./Img/foto_banderin.jpg"/>
                    </a>
                </figure>
            </article>
        </section>
